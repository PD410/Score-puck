...
void handleRoot() {
  ...
  // TEMPORARY: Send simple response to test if server works
  String simple = "<!DOCTYPE html><html><body>";
  simple += "<h1>ScorePuck Configuration</h1>";
  simple += "<p>Web server is working!</p>";
  simple += "<p>Full config page coming soon...</p>";
  simple += "</body></html>";

  Serial.println("    Sending simple test page...");
  server.send(200, "text/html", simple);
  Serial.println("    ✓ Page sent!");
}

// NOTE: Full HTML configuration page temporarily disabled for testing
// Will add back incrementally once simple version works
